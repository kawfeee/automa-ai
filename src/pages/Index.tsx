import { FileText, Mail, Video, Zap, FileEdit } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-[90%] xl:max-w-[1400px] mx-auto text-center">
          <h1 className="animated-heading text-4xl sm:text-6xl font-bold mb-6">
